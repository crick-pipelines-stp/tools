...
class ModulesJson:
    ...
    def recreate_dependencies(self, repo, base_org, subworkflow):
        """
        ...
        sw_path = Path(self.subworkflows_dir, base_org, subworkflow)
        dep_mods, dep_subwfs = get_components_to_install(sw_path)

        for org in self.modules_json["repos"][repo]["modules"]:
        ...
        for org in self.modules_json["repos"][repo]["subworkflows"]:
